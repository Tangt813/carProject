      ...
      <div class="topbar-account topbar-btn"  >
        <el-dropdown trigger="click">
          <span class="el-dropdown-link userinfo-inner"  >
           ...
           <font style="font-size: 16px">{{this.nickname}}</font>
            </span>
          <el-dropdown-menu>
            <el-dropdown-item>
              <div @click="jumpTo('/user/changepwd')"><span style="color: #555;font-size: 24px;">修改密码</span></div>
            </el-dropdown-item>
            <el-dropdown-item divided @click.native="logout" style="color: #555;font-size: 24px;">退出登录</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
    </el-col>
